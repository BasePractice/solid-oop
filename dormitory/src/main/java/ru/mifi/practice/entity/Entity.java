...
/**
 * Всё, что занимает место в комнате. Интерфейс намеренно широкий и почти весь
 * со значениями по умолчанию: большинству предметов нечего ответить на удар или
 * прикосновение, и они не должны об этом писать.
 */
