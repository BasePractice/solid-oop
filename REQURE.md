...
| 🟡 README только у 2 модулей из 10 | Есть [vol2/README.adoc](vol2/README.adoc) и [dormitory/README.adoc](dormitory/README.adoc). Остальные восемь — без постановки задачи. Корневой [README.md](README.md) — бейдж и ссылка на презентацию |
